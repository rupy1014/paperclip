...
import { productionPacketRoutes } from "./routes/production-packets.js";
import { deliverableBundleRoutes } from "./routes/deliverable-bundles.js";
...
export async function createApp(
  ...
  api.use(productionPacketRoutes(db));
  api.use(deliverableBundleRoutes(db));
